# Copyrig:ht (c) 2017-present, Facebook, Inc.
# All rights reserved.
#
...
# paths
parser.add_argument("--nlipath", type=str, default='dataset/ols/SNLI', help="NLI data path (SNLI or MultiNLI)")
